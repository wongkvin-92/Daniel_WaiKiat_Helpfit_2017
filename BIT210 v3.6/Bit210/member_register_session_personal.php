...
<html >
<head>
  <title>Member Register Personal Tranning Session</title>
  <meta charset="UTF-8">
  ...
  <!--Navigation bar on top of the page-->
    ...
    <div class="wrapper">
             ...
             <hr  class="line-sidebar">
              ...
              <li class="menu-spacing active">
                ...
                <ul class="collapse list-unstyled hoversub" id="pageSubmenu">
                  <li class="active"><a href="member_register_session_personal.php">Personal Training Sessions</a></li>
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Register Session Table (Personal)</h3>
                  </div>
                </div>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  <table id="pslSessionTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Title</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <button type="submit" name="submit" class="btn btn-success use-PTS">Register</button>
                        </div>
                        </td>
                      </tr>
                      <?php
     ...
     <!--The script needs to be loaded while the page is executed-->
      <script type="text/javascript" src="js/getSessionID.js"></script>
        <script>
          $(document).ready(function() {
            $('#pslSessionTable').DataTable();
          } );
        </script>
  </body>
</html>
