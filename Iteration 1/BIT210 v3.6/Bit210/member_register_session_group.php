...
<html >
<head>
  <title>Member Register Group Tranning Session</title>
  <meta charset="UTF-8">
  ...
  <!--Navigation bar on top of the page-->
    ...
    <div class="wrapper">
             ...
             <hr  class="line-sidebar">
              ...
              <li class="menu-spacing active">
                ...
                <ul class="collapse list-unstyled hoversub" id="pageSubmenu">
                  ...
                  <li class="active"><a href="member_register_session_group.php">Group Training Sessions</a></li>
                </ul>
              </li>
              <li class="menu-spacing">
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Register Session Table (Group)</h3>
                  </div>
                </div>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  <table id="grpSessionTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Title</th>
                    ...
                    <tbody>
                        ...
                        <?php
                          ...
                          $conn = mysqli_connect("localhost","root","","helpfit");
                            ...
                            $result = $conn->query("SELECT * FROM trainingsession where status= '$checkAvail' and sessionType = '$type'");


                           foreach ($result as $key => $rs) {
                            $trainerID = $rs['trainerID'];
                            $sql1 = $conn->query("SELECT fullName FROM trainer WHERE trainerID='$trainerID'");
                            foreach ($sql1 as $key => $value) {
                        ?>
                      <tr>
                        <td class="id"><?php echo $rs["sessionID"];?></td>
                        ...
                        <td><?php echo $rs["classType"];?></td>
                        <td><?php echo $value["fullName"];?></td>
                        <td>
                          <div class="text-center">
                          <button type="submit" name="submit" class="btn btn-success use-GTS">Register</button>
                        </div>
                        </td>
                      </tr>
                      <?php
     ...
     <!--The script needs to be loaded while the page is executed-->
      <script type="text/javascript" src="js/getSessionIDForGroup.js"></script>
        <script>
          $(document).ready(function() {
            $('#grpSessionTable').DataTable();
          } );
        </script>
  </body>
</html>
