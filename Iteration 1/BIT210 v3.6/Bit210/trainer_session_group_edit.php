...
<html>
<head>
	<title>Group Training Session Edit Page</title>
	<meta charset="utf-8">
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
     ...
     <div class="box col-xs-10 col-xs-offset-1 ">
        	<br/>
        		<a href="trainer_history_group.php" class="arrow"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a>
				...
				<form class="form" method="POST" action="addGpSession.php">
				     	...
				     	<div class="row ">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1" >
				                    <input type="text" name="title" class="form-control input-lg" id="inputName" placeholder="Title">
				        		    </div>
				            </div>
				          </div>
				    </br>
				    ...
				    <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                     <input type="text" class="form-control input-lg" id="datepicker" name="date" placeholder="Date">
				                </div>
				            </div>
				          </div>
				        </br>
				        <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="time" name="time" class="form-control input-lg" id="inputName" placeholder="Time">
				                </div>
				            </div>
				          </div>
				    </br>
						<div class="row ">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1" >
				                    <input type="text" name="fee" class="form-control input-lg" id="inputName" placeholder="Fees">
				        		    </div>
				            </div>
				          </div>
				        ...
				        <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="text" name="maxParticipant" class="form-control input-lg" id="inputName" placeholder="Max Participant">
				                </div>
				            </div>
				          </div>
