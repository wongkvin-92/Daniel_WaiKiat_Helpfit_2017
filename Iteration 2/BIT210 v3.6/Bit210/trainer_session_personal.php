...
<html>
<head>
	<title>Record Personal Training Session</title>
	<meta charset="utf-8">
				    ...
				    <div class="row">
				        ...
				        <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="time" name="time" class="form-control input-lg" id="timepicker" placeholder="Time" value="<?php echo $_SESSION['time'] ;?>">
				                </div>
				            </div>
				          </div>
				        ...
				        <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="text" name="fee" class="form-control input-lg" id="inputName" placeholder="Fee" value="<?php echo $_SESSION['fee'];?>">
				                </div>
				            </div>
				          </div>
