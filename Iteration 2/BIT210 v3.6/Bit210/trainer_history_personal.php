...
<head>
  <meta charset="UTF-8">
    <title>Trainer View Training History (Personal Session)</title>
             ...
             <hr  class="line-sidebar">
              ...
              <li class="menu-spacing active">
                ...
                <ul class="collapse list-unstyled hoversub " id="pageSubmenu">
                  <li class="active"><a href="trainer_history_personal.php">Personal Training Sessions</a></li>
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Training History Table (Personal)</h3>
                  </div>
                </div>
              </div>
                  ...
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="trainer_session_personal_edit.php"class="btn btn-default"><em class="fa fa-pencil"></em></a>
                      </div>
                      </td>
                    </tr>
                    <?php
