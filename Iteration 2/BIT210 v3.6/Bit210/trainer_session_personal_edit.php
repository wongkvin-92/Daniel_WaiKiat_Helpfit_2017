	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
     ...
     <div class="box col-xs-10 col-xs-offset-1 ">
        	...
        	<div class="midBox" >
				...
				<form class="form" method="POST" action="addPrSession.php">
				    ...
				    <div class="row">
				        ...
				        <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="time" name="time" class="form-control input-lg" id="timepicker" placeholder="Time">
				                </div>
				            </div>
				          </div>
				        ...
				        <div class="row">
				            <div class="form-group">
				                ...
				                <div class="col-xs-10 col-xs-offset-1">
				                    <input type="text" name="fee" class="form-control input-lg" id="inputName" placeholder="Fee">
				                </div>
				            </div>
				          </div>
