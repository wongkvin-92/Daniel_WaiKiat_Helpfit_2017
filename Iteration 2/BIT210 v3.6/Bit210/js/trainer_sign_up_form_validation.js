// Form validation code will come here.
   ...
   function validateForm(e){
     ...
     //Validate using name from the form/
        ...
        if(document.trainer_signup.password.value <6
        && document.trainer_signup.confirmpass.value <6 && document.trainer_signup.address.value <6
        && document.trainer_signup.password.value !== document.trainer_signup.password.value
        && reg.test(document.trainer_signup.emailadd.value) == false){
          e.preventDefault();
        }
